...
func (app *application) showMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	movie, err := app.models.Movies.Get(int32(id))
	if err != nil {
		switch {
...
func (app *application) deleteMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.models.Movies.Delete(int32(id))
	if err != nil {
		switch {
		case errors.Is(err, data.ErrRecordNotFound):
			app.notFoundResponse(w, r)
	...
	err = app.writeJSON(w, http.StatusOK, envelope{"success": "movie successfully deleted"}, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	input.Filters.SortSafelist = []string{"title", "id", "runtime", "year", "-id", "-title", "-runtime", "-year"}
